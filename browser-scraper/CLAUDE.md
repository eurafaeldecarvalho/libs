...
- **On every new session, first check whether caveman is active.** If it is not active, or not set to `ultra`, activate it immediately by running `/caveman ultra` before doing any other work.
